export const enUS = {
  ...
  sources: {
    ...
    content: "Content",
    metadata: "Metadata",
    preprocessPreview: "Cleaned Preview",
    preprocessPreviewDesc: "Review the original text, cleaned text, and semantic chunks that will be embedded.",
    preprocessPreviewFailed: "Failed to load preprocessing preview",
    preprocessPreviewEmpty: "Preprocessing preview has not been loaded yet.",
    loadPreprocessPreview: "Load Cleaned Preview",
    originalText: "Original Text",
    cleanedText: "Cleaned Text",
    finalChunks: "Final Chunks",
  ...
  studio: {
    title: "Studio",
    desc: "Create custom templates, generate reports, FAQs, and timelines from your notebook content.",
    // 模板管理
    templates: "Templates",
    templatesDesc: "Manage custom prompt templates for content generation.",
    createNewTemplate: "Create New Template",
    editTemplate: "Edit Template",
    templateName: "Template Name",
    templateNamePlaceholder: "Unique identifier, e.g. summary_template",
    templateDescriptionPlaceholder: "Describe what this template does...",
    outputFormat: "Output Format",
    templatePrompt: "Prompt",
    templatePromptPlaceholder: "Write the prompt that will power this template...",
    noTemplates: "No templates yet",
    deleteConfirmTitle: "Delete Template",
    deleteConfirmDesc: "Are you sure you want to delete this template? This action cannot be undone.",
    ...
    reportDesc: "Generate academic, business, or brief summary reports from notebook content.",
    reportType: "Report Type",
    reportTypeAcademic: "Academic Report",
    reportTypeBusiness: "Business Report",
    reportTypeBrief: "Brief Summary",
    selectNotebook: "Select Notebook",
    ...
    // FAQ 生成
    faq: "FAQ Generator",
    faqDesc: "Generate frequently asked questions and answers from notebook content.",
    numQuestions: "Number of Questions",
    generateFAQ: "Generate FAQ",
    faqResult: "FAQ List",
    noFAQs: "No FAQs generated yet",
    // 时间线生成
    timeline: "Timeline Generator",
    timelineDesc: "Extract events from notebook content and display them in chronological order.",
    generateTimeline: "Generate Timeline",
    timelineResult: "Timeline",
    noTimelineEvents: "No timeline events generated yet",
  },
  models: {
  ...
  apiKeys: {
    ...
    syncAndAssign: "Sync & Auto-Assign",
    syncAndAssigning: "Syncing and assigning...",
    syncAndAssignSuccess: "Discovered {discovered} models, added {new} new, and auto-assigned {assigned} defaults",
    syncAndAssignNoModels: "No syncable or assignable models were found. Please configure an available provider first.",
    syncAndAssignFailed: "Failed to sync and auto-assign models",
