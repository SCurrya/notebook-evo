export const zhCN = {
  ...
  sources: {
    ...
    content: "内容",
    metadata: "元数据",
    preprocessPreview: "清洗预览",
    preprocessPreviewDesc: "查看原始文本、清洗后的文本，以及即将写入向量库的语义分块。",
    preprocessPreviewFailed: "加载清洗预览失败",
    preprocessPreviewEmpty: "尚未加载预处理预览。",
    loadPreprocessPreview: "加载清洗预览",
    originalText: "原始文本",
    cleanedText: "清洗后文本",
    finalChunks: "最终 Chunk",
  ...
  studio: {
    title: "工作室",
    desc: "创建自定义模板，从笔记本内容生成报告、FAQ 和时间线。",
    // 模板管理
    templates: "模板管理",
    templatesDesc: "管理用于内容生成的自定义提示词模板。",
    createNewTemplate: "创建新模板",
    editTemplate: "编辑模板",
    templateName: "模板名称",
    templateNamePlaceholder: "唯一标识符，如 summary_template",
    templateDescriptionPlaceholder: "描述此模板的功能...",
    outputFormat: "输出格式",
    templatePrompt: "提示词",
    templatePromptPlaceholder: "编写驱动此模板的提示词...",
    noTemplates: "暂无模板",
    deleteConfirmTitle: "删除模板",
    deleteConfirmDesc: "确定要删除此模板吗？此操作无法撤销。",
    templateCreateSuccess: "模板创建成功",
    templateUpdateSuccess: "模板更新成功",
    templateDeleteSuccess: "模板删除成功",
    // 报告生成
    report: "报告生成器",
    reportDesc: "从笔记本内容生成学术、商业或简短摘要报告。",
    reportType: "报告类型",
    reportTypeAcademic: "学术报告",
    reportTypeBusiness: "商业报告",
    reportTypeBrief: "简短摘要",
    selectNotebook: "选择笔记本",
    selectNotebookPlaceholder: "选择一个笔记本...",
    generateReport: "生成报告",
    generating: "正在生成...",
    reportResult: "报告内容",
    ...
    // 时间线生成
    timeline: "时间线生成器",
    timelineDesc: "从笔记本内容中提取事件并按时间顺序展示。",
  ...
  apiKeys: {
    ...
    testFailed: "连接测试失败",
    syncModels: "同步模型",
    syncAndAssign: "同步并自动分配",
    syncAndAssigning: "正在同步并分配...",
    syncAndAssignSuccess: "已发现 {discovered} 个模型，新增 {new} 个，并自动分配 {assigned} 个默认项",
    syncAndAssignNoModels: "未发现可同步或可分配的模型，请先配置可用提供商。",
    syncAndAssignFailed: "同步并自动分配失败",
